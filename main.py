...
def main():
    ...
    num_max_iter = max(num_iter_source, num_iter_target, args.num_max_iter)
    ...
    if num_source_train > num_source:
        print(f"Source dataset will be repeated {num_source_train // num_source} times.")

    if num_target_train > num_target:
        print(f"Source dataset will be repeated {num_target_train // num_target} times.")
