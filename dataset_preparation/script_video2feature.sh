...
# ----------------------------------------------------------------------------------
# variable
data_path=/media/david/damysus/datasets/adl/ #/dataset/hmdb51/ # depend on users
...
class_file=../data/class_list_adl.txt # ../data/hmdb51_splits/class_list_hmdb_ucf_small.txt # none | XXX/class_list_DA.txt (depend on users)

echo python -W ignore video2feature.py --data_path $data_path --video_in $video_in \
